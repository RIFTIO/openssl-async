...
EVP_PKEY_TLS1_PRF - TLS PRF key derivation algorithm
...
The EVP_PKEY_TLS1_PRF implements the PRF key derivation function for
...
TLS PRF. The EVP_md5_sha1() is treated as a special case which uses the PRF
algorithm using both B<MD5> and B<SHA1> as uses in TLS 1.0 and 1.1.
